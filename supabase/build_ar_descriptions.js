/**
 * build_ar_descriptions.js
 * Hand-crafted Arabic translations for all 24 German HTML descriptions.
 * Preserves all HTML tags/classes/attributes exactly.
 * Only translates the visible text content.
 * No non-Arabic characters except: digits, €, %, HTML tag syntax, whitespace.
 */
'use strict';
const fs = require('fs');
const path = require('path');

// Each entry: { id, shortId, table, ar_description }
// The <table class="tour-pricing-table"> and all HTML attributes preserved verbatim.
// The visible text translated from German to Arabic.

const translations = [
  {
    id: '42a2941f-6b90-4f0a-9593-0ec1ec980a13',
    shortId: '42a2941f',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>المشاركون</th><th>المركبة</th><th>السعر للشخص الواحد</th></tr></thead><tbody><tr><td>شخصان</td><td>ليموزين خاصة</td><td>150 € للشخص الواحد</td></tr><tr><td>3 – 4 أشخاص</td><td>حافلة صغيرة خاصة</td><td>135 € للشخص الواحد</td></tr><tr><td>5 – 6 أشخاص</td><td>حافلة صغيرة خاصة</td><td>100 € للشخص الواحد</td></tr><tr><td>7 – 8 أشخاص</td><td>حافلة صغيرة خاصة</td><td>90 € للشخص الواحد</td></tr></tbody></table>
...
هذه الجولة مثالية لمحبي التاريخ، والعائلات، والمسافرين الراغبين في تجربة القلب الثقافي لمصر في يوم واحد.`
  ...
  {
    id: '77f34e21-9d9d-4be6-90b3-8148b2d82214',
    shortId: '77f34e21',
    table: 'tours',
...
مع جولتنا الخاصة في مدينة الجونة، ستكتشف المدينة بأسلوبك الفريد: بلا توقفات للبيع، وبلا مجموعات كبيرة، بل برفقة مرشد ذي خبرة وناطق بالألمانية واهتمام شخصي. تجمع الجولة بين رحلة بحرية خلابة في البحيرة، ومعالم ثقافية متنوعة، وزيارة برج المراقبة الشهير الذي يتيح لك أحد أجمل المناظر البانورامية في الجونة بأكملها.`
  ...
  {
    id: 'c2db0455-a5c7-47f9-8925-2ce6dcc3434a',
    shortId: 'c2db0455',
    table: 'tours',
...
حين تغرب الشمس ويكتسي الأفق بدرجات الحمرة، تظهر الغردقة بأجمل صورها. تضيء المارينا، وتنبض الأسواق بالحياة، وتتنفس المدينة الصعداء. في هذه اللحظة بالضبط، نرافقك في أجواء المساء الغامضة — بلا ازدحام، مريحة وشخصية.`
  ...
  {
    id: '7cb0c635-f7a7-4d98-a9b0-cde4997ca8ae',
    shortId: '7cb0c635',
    table: 'tours',
...
✔️ بعض النقود للإكراميات ودورات المياه`
  ...
  {
    id: '2dc6864a-30cb-4a8e-8277-a54c2ed8ca7d',
    shortId: '2dc6864a',
    table: 'tours',
...
هذه الرحلة مناسبة بشكل خاص للمسافرين المهتمين بالثقافة، والمسيحيين، وهواة التاريخ، والضيوف الراغبين في اكتشاف مصر الأصيلة بعيداً عن المسارات السياحية المعروفة.`
  ...
  {
    id: '1c5a3c79-ab29-46c7-b480-36954adcc661',
    shortId: '1c5a3c79',
    table: 'tours',
...
مثالية للضيوف الذين لا يرغبون في قضاء وقت قصير في الأقصر، بل يريدون تجربة أبرز معالم المدينة القديمة بأسلوب مريح ومكثّف.`
  ...
  {
    id: '4f91f20d-ead4-4473-8700-371d4cb5fc4e',
    shortId: '4f91f20d',
    table: 'tours',
...
هذه الجولة مثالية للضيوف الراغبين في اكتشاف الغردقة خارج أسوار الفندق وتذوّق الحياة السوقية المحلية الأصيلة. بعد التسوق، نوصلك بأمان إلى فندقك.`
  ...
  {
    id: '69aa0c36-125f-4f41-8502-55a8f4fd6d98',
    shortId: '69aa0c36',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 35 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 8:00 صباحاً</td></tr></tbody></table>
...
تُعرف أورانج باي بـ"كاريبي مصر"، وتُبهج الزوار بشاطئها الرملي الأبيض، ومياهها الصافية، وعالمها الفريد تحت الماء. الرحلة مثالية للعائلات، والأزواج، والمجموعات، ومبتدئي الغطس.`
  ...
  {
    id: '17a82d9b-2d00-4a29-8528-3c2e97a6bf26',
    shortId: '17a82d9b',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 95 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 8:00 صباحاً</td></tr></tbody></table>
...
✔ مثالية للأزواج والعائلات وعشاق البحر`
  ...
  {
    id: 'a8ddb433-a4fb-41ca-b90d-b399b4a57923',
    shortId: 'a8ddb433',
    table: 'tours',
...
يقع مجمع المعابد على بُعد نحو 60 كيلومتراً شمال مدينة الأقصر، ويعود إلى الحقبة البطلمية الرومانية. بفضل حفاظه الممتاز، يُعدّ من أبرز الشواهد على الفن والعلوم المصرية القديمة.`
  ...
  {
    id: '0009b90b-71a9-4e78-8459-e56bacce7cbf',
    shortId: '0009b90b',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 20 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 12:00 ظهراً</td></tr></tbody></table>
...
تحظى الجولة بإقبال خاص من العائلات ذات الأطفال، وغير السباحين، والضيوف الراغبين في استكشاف الشعاب المرجانية في الغردقة بطريقة آمنة ومريحة.`
  ...
  {
    id: 'b604535f-6c99-4766-9150-c29fbbf5678c',
    shortId: 'b604535f',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 75 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 8:00 صباحاً</td></tr></tbody></table>
...
✓ مناسبة للمبتدئين والسباحين ذوي الخبرة`
  ...
  {
    id: 'f265b20c-db45-4173-a352-b1921fd7f744',
    shortId: 'f265b20c',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 35 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 8:00 صباحاً</td></tr></tbody></table>
...
جزيرة هولا هولا مثالية للضيوف الراغبين في رحلة غطس مريحة من الغردقة مع إقامة على الجزيرة، ومياه نقية، ونقل بالقارب في راحة تامة.`
  ...
  {
    id: '27ae0b35-e0ef-4b01-9aa7-23d3210d74ff',
    shortId: '27ae0b35',
    table: 'tours',
...
في الشتاء: سترة خفيفة`
  ...
  {
    id: 'c7b7cfad-0101-4997-ac52-e4456a21c252',
    shortId: 'c7b7cfad',
    table: 'tours',
...
مثالية للضيوف المميزين الراغبين في تجربة القاهرة بأسلوب فردي.`
  ...
  {
    id: 'b2dc19de-fc9f-4a96-a742-7646e16a8486',
    shortId: 'b2dc19de',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>المشاركون</th><th>القارب</th><th>السعر للشخص الواحد</th></tr></thead><tbody><tr><td>شخص واحد</td><td>قارب سريع خاص</td><td>150 € للشخص الواحد</td></tr><tr><td>شخصان</td><td>قارب سريع خاص</td><td>80 € للشخص الواحد</td></tr><tr><td>3 أشخاص</td><td>قارب سريع خاص</td><td>70 € للشخص الواحد</td></tr><tr><td>4 أشخاص</td><td>قارب سريع خاص</td><td>60 € للشخص الواحد</td></tr><tr><td>5 أشخاص</td><td>قارب سريع خاص</td><td>55 € للشخص الواحد</td></tr><tr><td>6 أشخاص</td><td>قارب سريع خاص</td><td>50 € للشخص الواحد</td></tr></tbody></table>
...
في فترة ما بعد الظهر، يستقبلك سائق مباشرةً من فندقك في الغردقة وينقلك إلى الميناء. ينتظرك قاربك السريع الخاص، الذي سيأخذك إلى مواقع غطس مختارة ومناطق ساحلية هادئة.`
  ...
  {
    id: '6b629662-908c-40e3-b396-565393a6be18',
    shortId: '6b629662',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 50 € للشخص الواحد</td><td>تذكرة دخول</td><td>يومياً</td><td>نحو الساعة 9:00 صباحاً</td></tr></tbody></table>
...
تتوفر في الحديقة مطاعم متعددة ومقاهي وجبات خفيفة ومناطق جلوس مظللة.`
  ...
  {
    id: '94351900-ac6d-4c76-92e1-f9e1b1744f2f',
    shortId: '94351900',
    table: 'tours',
    ar_description: `يبدأ يوم استثنائي
...
مشروبات مجانية تُرطّبك طوال الرحلة بينما تتهيّأ لاستقبال العاصمة المصرية الرائعة.`
  ...
  {
    id: '80dc4e17-ea30-4511-92be-5e8add77f139',
    shortId: '80dc4e17',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 45 € للشخص الواحد</td><td>تذكرة دخول مع نقل</td><td>يومياً</td><td>نحو الساعة 10:00 صباحاً</td></tr></tbody></table>
...
لا تفوّت الوجهة المميزة على البحر الأحمر — تجربة لا تُنسى للصغار والكبار!`
  ...
  {
    id: '65f786e7-75c3-457b-a66a-e9f91f2c950e',
    shortId: '65f786e7',
    table: 'tours',
...
💎 مثالية للأزواج والعائلات والمجموعات الصغيرة الراغبين في تجربة أبرز ما تقدّمه القاهرة — بلا رحلات حافلة طويلة مرهقة.`
  ...
  {
    id: '380712ad-0b71-4e9a-8bfd-4e34c6906afc',
    shortId: '380712ad',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 30 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 8:00 صباحاً</td></tr></tbody></table>
استمتع برحلة مثيرة بالدراجة الرباعية في الغردقة تأخذك عبر المناظر الطبيعية الصحراوية الرائعة لمدة 3 ساعات. تبدأ بإيجاز عن السلامة، ثم تقود دراجتك الرباعية عبر الكثبان الرملية وأودية الأنهار الجافة. بعدها تنتظرك رحلة بالجمال إلى قرية بدوية تقليدية، حيث ستتعرف على الحياة البدوية اليومية وتستمتع بمشروب تقليدي. توفر الرحلة مزيجاً مثالياً بين المغامرة والتجربة الثقافية في الصحراء المصرية.`
  ...
  {
    id: '872d19ae-dd4c-4c01-9f1b-217e481b3732',
    shortId: '872d19ae',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 40 € للشخص الواحد</td><td>جولة جماعية</td><td>يومياً</td><td>نحو الساعة 13:00</td></tr></tbody></table>
...
بعد الاستقبال من الفندق، تتوجّه أولاً إلى محطة الدراجات الرباعية، حيث تتلقى إيجازاً عن السلامة ثم تنطلق عبر الصحراء على دراجات رباعية القيادة الذاتية. بعدها تنتقل إلى سيارات الجيب التي تأخذك إلى محطة ركوب الجمال. هناك يمكنك ركوب الجمال والاستمتاع بالمناظر الصحراوية. وفي الختام تصل إلى قرية بدوية تقليدية تنتظرك فيها وجبة شواء عطرة. استمتع بغروب الشمس فوق الكثبان الرملية وعِش تجربة الضيافة البدوية الأصيلة.`
  ...
  {
    id: 'a9e92b99-283c-4b1e-ac9a-12bfe9c7fef0',
    shortId: 'a9e92b99',
    table: 'tours',
...
في اليوم الأول تغادر الغردقة في الصباح الباكر وتصل إلى القاهرة بعد نحو 5 ساعات. هناك تزور أولاً أهرامات الجيزة وأبو الهول، ثم تتوجّه إلى فندقك لقضاء الليل. وفي اليوم الثاني تزور المتحف المصري، وحي خان الخليلي العتيق، ومسجد المرمر. بعد الغداء تعود إلى الغردقة.`
  ...
  {
    id: '8c5d9ce5-9931-42a6-8f09-44adf155d616',
    shortId: '8c5d9ce5',
    table: 'tours',
    ar_description: `<table class="tour-pricing-table"><thead><tr><th>السعر</th><th>نوع الرحلة</th><th>موعد الانطلاق</th><th>الاستقبال</th></tr></thead><tbody><tr><td>من 35 € للشخص الواحد</td><td>فردي</td><td>يومياً</td><td>نحو الساعة 10:00 صباحاً</td></tr></tbody></table>
...
console.log(`Written ${translations.length} entries to ${outputFile}`);

// Verify all 24 IDs are present
const expectedIds = [
...
const foundIds = translations.map(t => t.shortId);
...
if (!missing.length && !extra.length) console.log('✓ All 24 IDs accounted for');
