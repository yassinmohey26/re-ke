// Full Migration Script — Steps 1-4 + 8 (DB writes)
// Run from: nextjs-app/ with: node scripts/run-full-migration.cjs
...
const MIGRATION = [
  { tourId: '7b681580-bfb6-4e96-913f-47c64cf2231c', slug: 'private-speedboot-tour-orange-bay-hurghada', timeSlots: ['08:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'примерно в {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} صباحاً' } },
  { tourId: '2dc6864a-30cb-4a8e-8277-a54c2ed8ca7d', slug: 'kloester-st-antonius-st-paulus', timeSlots: ['04:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'около {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} صباحاً' } },
  { tourId: '14475177-96d0-4d67-b5ca-4b277f3d6a7e', slug: 'family-safari-hurghada', timeSlots: ['08:30', '13:30'],
    templates: { de: 'ca. {time}', en: 'Hotel lobby in Hurghada (approx. {time} – exact pick-up time confirmed upon booking)', ru: 'Лобби вашего отеля в Хургаде (около {time} – точное время подтверждается при бронировании)', fr: "Hall de votre hôtel à Hurghada (vers {time} – l'heure exacte de prise en charge est confirmée lors de la réservation)", hu: 'Hurghada-i szállodájának recepciója (kb. {time} – a pontos felvételi időt a foglaláskor erősítik meg)', ar: 'ردهة فندقك في الغردقة (حوالي الساعة {time} – يُؤكد وقت الاستلام الدقيق عند الحجز)' } },
  { tourId: '17a82d9b-2d00-4a29-8528-3c2e97a6bf26', slug: 'mahmya-insel-ausflug-hurghada', timeSlots: ['08:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'ок. {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} صباحاً' } },
  { tourId: '5a9c2e86-9d98-41de-a4c4-54523b45cf13', slug: 'family-abendsafari-hurghada', timeSlots: [],
    templates: { de: 'Hurghada - Rotes Meer - Aegypten', en: 'Hurghada - Red Sea - Egypt', ru: 'Хургада - Красное море - Египет', fr: 'Hurghada - Mer Rouge - Egypte', hu: 'Hurghada - Vörös-tenger - Egyiptom', ar: 'الغردقة - البحر الأحمر - مصر' } },
  ...
  { tourId: '8c5d9ce5-9931-42a6-8f09-44adf155d616', slug: 'mini-egypt-park-hurghada', timeSlots: ['10:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'ок. {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'بالتواصل معنا' } },
  ...
  { tourId: '1c5a3c79-ab29-46c7-b480-36954adcc661', slug: 'luxor-tagesausflug-heissluftballon-hoteluebernachtung', timeSlots: ['17:00'],
    templates: { de: 'ca. {time}', en: 'approx. {time}', ru: 'ок. {time}', fr: 'vers {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} مساءً' } },
  ...
  { tourId: '80dc4e17-ea30-4511-92be-5e8add77f139', slug: 'eintrittskarte-zum-hurghada-grand-aquarium', timeSlots: ['10:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'около {time}', fr: 'vers {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} صباحاً' } },
  ...
  { tourId: '0009b90b-71a9-4e78-8459-e56bacce7cbf', slug: 'glasbodenboot-hurghada-mit-schnorcheln', timeSlots: ['12:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'около {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} ظهراً' } },
  { tourId: 'c2db0455-a5c7-47f9-8925-2ce6dcc3434a', slug: 'naechtliche-stadtrundfahrt-durch-hurghada-private-tour', timeSlots: ['19:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'ок. {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} مساءً' } },
  { tourId: 'b2dc19de-fc9f-4a96-a742-7646e16a8486', slug: 'privater-speedboot-ausflug-in-hurghada-schnorcheln-an-korallenriffen-sonnenuntergang', timeSlots: ['12:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'примерно в {time}', fr: 'env. {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} مساءً' } },
  ...
  { tourId: '42a2941f-6b90-4f0a-9593-0ec1ec980a13', slug: 'luxor-tagesausflug-ab-hurghada', timeSlots: ['04:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'ок. {time}', fr: 'vers {time}', hu: 'kb. {time}', ar: 'حوالي الساعة {time} فجراً' } },
  ...
  { tourId: '30cb3bb8-2bcb-4863-a0ca-49220bdb6a1d', slug: 'mega-safari-hurghada', timeSlots: ['08:30', '15:00'],
    templates: { de: 'ca. {time}', en: 'Around {time}', ru: 'Около {time}', fr: 'Vers {time}', hu: 'Kb. {time}', ar: 'حوالي {time}' } },
  { tourId: 'a9e92b99-283c-4b1e-ac9a-12bfe9c7fef0', slug: '2-tages-ausflug-nach-kairo-ab-hurghada-pyramiden-sphinx-aegyptische-geschichte-erleben', timeSlots: ['02:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'Хургада - Красное море - Египет', fr: 'Hurghada - Mer Rouge - Egypte', hu: 'Hurghada - Vörös-tenger - Egyiptom', ar: 'حوالي الساعة {time} صباحاً' } },
  ...
  { tourId: '3ebed770-c1d0-44dd-8d95-590fdec83f74', slug: 'reiten-in-hurghada-strand-wueste-pferde-im-meer', timeSlots: ['10:00'],
    templates: { de: 'ca. {time} Uhr', en: 'approx. {time}', ru: 'около {time}', fr: 'environ {time}', hu: 'kb. {time}', ar: 'نحو الساعة {time}' } },
...
(async () => {
  // --- STEP 1: Verify/add pickup_time_slots column ---
  console.log('\n' + '='.repeat(60));
  console.log('STEP 1: Verify pickup_time_slots column exists');
  console.log('='.repeat(60));
  const { error: colCheckErr } = await db.from('tours').select('pickup_time_slots').limit(1);
  if (colCheckErr && colCheckErr.message.includes('pickup_time_slots')) {
    console.error('❌ Column missing. Please run this in Supabase SQL editor:');
    console.error("  ALTER TABLE tours ADD COLUMN IF NOT EXISTS pickup_time_slots JSONB DEFAULT '[]'::jsonb;");
    process.exit(1);
  } else if (colCheckErr) {
    console.error('❌ Unexpected error:', colCheckErr.message);
    process.exit(1);
  }
  console.log('✅ Column pickup_time_slots exists.');
  ...
  console.log(errs === 0 ? '✅ Step 2 complete.' : `⚠️  ${errs} errors in Step 2.`);

  // --- STEP 3: Fix Grand Aquarium category_label ---
  console.log('\n' + '='.repeat(60));
  console.log('STEP 3: Fix Grand Aquarium category_label (en/ru/fr/hu)');
  console.log('='.repeat(60));
  errs = 0;
  ...
  console.log(errs === 0 ? '✅ Step 3 complete.' : `⚠️  ${errs} errors in Step 3.`);
  ...
  console.log(errs === 0 ? '✅ Step 8 complete.' : `⚠️  ${errs} errors in Step 8.`);
  ...
  console.log('\n\n✅ DB MIGRATION COMPLETE (Steps 1-4, 8).');
})();
